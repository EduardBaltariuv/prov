...
import 'package:hospital_app/theme/app_theme.dart';
...
Future<void> main() async {
  ...
  // Create AuthViewModel and OTAUpdateService instances first
  ...
  try {
    await otaUpdateService.init();
    // Check for updates on app start
    await otaUpdateService.checkForUpdates();
    debugPrint('OTA service initialized successfully');
  } catch (e) {
    debugPrint('OTA service initialization failed: $e');
  }
    ...
    return MaterialApp(
      ...
      home: Consumer<AuthViewModel>(
        builder: (context, auth, _) {
          return auth.getToken != null ? const MainScreen() : const LoginScreen(key: ValueKey('login'));
        },
      ),
